...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    if (hideDefaultCursor) {
      ...
      // Class ini dipakai CSS (body.target-cursor-active ...) untuk memaksa
      // cursor: none di semua elemen — termasuk link/button yang punya
      // `cursor: pointer` sendiri, supaya kursor asli tidak "bocor".
    ...
    const enterHandler = e => {
      ...
      if (cursorColorOnTarget) {
        ...
        if (dotRef.current) {            gsap.to(dotRef.current, {
