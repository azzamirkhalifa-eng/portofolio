...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({
      ...
      // Batasi DPI supaya render tetap ringan di layar retina.
    ...
    // Hentikan rendering saat keluar layar / tab tersembunyi (hemat GPU).
    let isVisible = true;
    ...
    const sync = () => (isVisible && isPageVisible ? start() : stop());
